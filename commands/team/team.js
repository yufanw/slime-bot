    ...
    async run(message) {
        ...
        if (command === "team") {
            ...
            if (message.channel.name === teamChannel) {
                ...
                let fullteam1 = !_.includes(team1, undefined) && team1.length === 10;
                let fullteam2 = !_.includes(team2, undefined) && team2.length === 10;
                let fullteam3 = !_.includes(team3, undefined) && team3.length === 10;

                //variable for if party includes member
                let includesMember1 = _.includes(team1, member.userName);
                let includesMember2 = _.includes(team2, member.userName);
                let includesMember3 = _.includes(team3, member.userName);
                ...
                if (prop === "checkin") {
                    ...
                    if (value === '3') {
                        ...
                        else if (_.includes(team3, member.userName)) {
                        ...
                        else if (_.includes(team2, member.userName)) {
                            return message.reply(`You're already checked in!`)
                        }
                        ...
                        if (fullteam1) {
                            ...
                            if (_.includes(team2, member.userName) || _.includes(team3, member.userName)) {
                        ...
                        // if team 2 is full
                            ...
                            if (_.includes(team1, member.userName) || _.includes(team3, member.userName)) {
                                return message.reply(`${name2} is full, and you are already checked in to ${name1} and ${name3}`)
                            }

                            else if (_.includes(team1, undefined) && team1.length !== 6) {
                                teamPush(member, teamTeam1);
                        ...
                        else if (_.includes(team1, member.userName)) {
                            return message.reply(`You're already checked in!`)
                        }
                ...
                // adding member
                    ...
                    if (value === 'team1') {
                        ...
                        if (_.includes(team1, secondValue.join(" "))) {
                        ...
                        if (_.includes(team2, secondValue.join(" "))) {
                        ...
                        if (_.includes(team3, secondValue.join(" "))) {
                ...
                // mentioning checked-in members
                    ...
                    if (value === 'team1') {
                        ...
                        let user1 = message.guild.members.find(member => member.userName == _.get(team1, '0.userName'));

                        let user2 = message.guild.members.find(member => member.userName == _.get(team1, '1.userName'));

                        let user3 = message.guild.members.find(member => member.userName == _.get(team1, '2.userName'));

                        let user4 = message.guild.members.find(member => member.userName == _.get(team1, '3.userName'));

                        let user5 = message.guild.members.find(member => member.userName == _.get(team1, '4.userName'));

                        let user6 = message.guild.members.find(member => member.userName == _.get(team1, '5.userName'));

                        let user7 = message.guild.members.find(member => member.userName == _.get(team1, '6.userName'));

                        let user8 = message.guild.members.find(member => member.userName == _.get(team1, '7.userName'));

                        let user9 = message.guild.members.find(member => member.userName == _.get(team1, '8.userName'));

                        let user10 = message.guild.members.find(member => member.userName == _.get(team1, '9.userName'));
                    ...
                    if (value === 'team2') {
                        let user1 = message.guild.members.find(member => member.userName == _.get(team2, '0.userName'));

                        let user2 = message.guild.members.find(member => member.userName == _.get(team2, '1.userName'));

                        let user3 = message.guild.members.find(member => member.userName == _.get(team2, '2.userName'));

                        let user4 = message.guild.members.find(member => member.userName == _.get(team2, '3.userName'));

                        let user5 = message.guild.members.find(member => member.userName == _.get(team2, '4.userName'));

                        let user6 = message.guild.members.find(member => member.userName == _.get(team2, '5.userName'));

                        let user7 = message.guild.members.find(member => member.userName == _.get(team2, '6.userName'));

                        let user8 = message.guild.members.find(member => member.userName == _.get(team2, '7.userName'));

                        let user9 = message.guild.members.find(member => member.userName == _.get(team2, '8.userName'));

                        let user10 = message.guild.members.find(member => member.userName == _.get(team2, '9.userName'));
                    ...
                    if (value === 'team3') {
                        ...
                        let user1 = message.guild.members.find(member => member.userName == _.get(team3, '0.userName'));

                        let user2 = message.guild.members.find(member => member.userName == _.get(team3, '1.userName'));

                        let user3 = message.guild.members.find(member => member.userName == _.get(team3, '2.userName'));

                        let user4 = message.guild.members.find(member => member.userName == _.get(team3, '3.userName'));

                        let user5 = message.guild.members.find(member => member.userName == _.get(team3, '4.userName'));

                        let user6 = message.guild.members.find(member => member.userName == _.get(team3, '5.userName'));

                        let user7 = message.guild.members.find(member => member.userName == _.get(team3, '6.userName'));

                        let user8 = message.guild.members.find(member => member.userName == _.get(team3, '7.userName'));

                        let user9 = message.guild.members.find(member => member.userName == _.get(team3, '8.userName'));

                        let user10 = message.guild.members.find(member => member.userName == _.get(team3, '9.userName'));
